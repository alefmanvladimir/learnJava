...
List<String> listString;
	...
	void addIndexTest() {
		...
		assertTrue(listInt.add(400, -1));
		assertTrue(listInt.add(400, 100));
	...
	void removeTest() {
		...
		assertTrue(listInt.remove(-1));
		assertTrue(listInt.remove(listInt.size()));
	...
	void swapTest() {
		...
		assertTrue(listInt.swap(-10, 1));
		assertTrue(listInt.swap(1, 10));
	}
